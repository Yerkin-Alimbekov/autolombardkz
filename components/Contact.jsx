...
const Contact = () => {
  ...
  return (
    <section className="pt-8 xl:pt-10 pb-52" id="contact">
      <div className="container mx-auto">
        <div className="flex flex-col items-center xl:flex-row gap-16">
          <div className="flex-1 mx-auto xl:mx-0 flex flex-col">
          <div>
              <p className="h3 text-center text-primary text-[18px] text-xl mb-[-5px]">
                Узнайте сколько Вы получите
                </p>
            </div>
            <div className="flex text-[10px] justify-center gap-1 mb-[-14px]">
            <span className="text-primary text-[15px]">*</span>
                <p>Нажимая любую из кнопок на сайте,
                </p>
            </div>
            <div className="flex text-[10px] justify-center gap-1 mb-[22px]">
                <p>Вы соглашаетесь с политикой конфеденциальности</p>
            </div>
