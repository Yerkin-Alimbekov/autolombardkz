        ...
        <Card>
          <div style={{ overflowY: "auto", padding: "12px" }}>
            <Typography variant="h5" align="center">
                Рассчитайте условия on-line
            <div className="flex text-[10px] justify-center gap-1 mb-[-5px]">
            ...
            <span className="text-red-600 text-[15px]">*</span>
                <p>ставка вознаграждения регулируется НБ РК</p>
            </div>
            </Typography>
            <Box sx={{ m: 7 }} />
                    ...
                    <TableBody>
                      <TableRow>
                        <TableCell align="center">
                          <Typography className="text-[14px] font-thin text-primary" variant="p">Сумма ежемесячного платежа: </Typography>
                          <Box sx={{ m: 1 }} />
                ...
                <TableContainer component={Paper}>
                  <Table aria-label="simple table">
                    <TableBody>
                      <TableRow>
                        <TableCell align="center">
                          <Typography className="text-[14px] font-thin text-primary" variant="p">
                ...
                <TableContainer component={Paper}>
                  <Table aria-label="simple table">
                    <TableBody>
                      <TableRow>
                        <TableCell align="center">
                          <Typography className="text-[14px] font-thin text-primary" variant="p">Общая сумма к возврату (ОД + %): </Typography>
                          <Box sx={{ m: 1 }} />
                          <Typography variant="h6" className="font-normal">
                             {totalinterest} тенге
                          </Typography>
